...
describe('Noteful API - Login', function () {
  ...
  describe('Validate Password', function () {
    it('Should return true if they match', function () {
      return expect(User.validatePassword('password', '$2a$10$yI/zColthWsWaRo34OBsF.1D6Z4HoS3PNLPRdoAKzdKjT7k4Og9He')).to.be.true;
    });

    it('Should return false if they do not match', function () {
      return expect(User.validatePassword('badpassword', '$2a$10$yI/zColthWsWaRo34OBsF.1D6Z4HoS3PNLPRdoAKzdKjT7k4Og9He')).to.be.true;
    });
